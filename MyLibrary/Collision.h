...
namespace Collision
{
	...
	bool CheckLineHitObjectA(VECTOR3 pos1, VECTOR3 pos2); // true→pos1とpos2の線分に当たるオブジェクトがある
	...
	VECTOR3 CheckPushObjectB(Object3D* obj, VECTOR3 capsule1, VECTOR3 capsule2, float capsuleR); // 他のオブジェクトにめり込んでいない場所に移動させた値を返す
